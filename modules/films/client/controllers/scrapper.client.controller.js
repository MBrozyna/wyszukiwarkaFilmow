(function () {
  ...
  ScrapperController.$inject = ['$scope', '$state', '$q', 'Authentication', 'filmResolve', 'FilmsService'];

  function ScrapperController ($scope, $state, $q, Authentication, film, FilmsService) {
    var vm = this;
